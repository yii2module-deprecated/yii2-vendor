...
$this->title = Yii::t('github/local', 'list');
...
$columns = [
	...
	[
		'label' => Yii::t('github/local', 'has_readme'),
		'format' => 'raw',
		'value' => function($data){
			if($data->has_readme) {
	...
	[
		'label' => Yii::t('github/local', 'has_guide'),
		'format' => 'raw',
		'value' => function($data){
			if($data->has_guide) {
	...
	[
		'label' => Yii::t('github/local', 'has_license'),
		'format' => 'raw',
		'value' => function($data){
			if($data->has_license) {
	...
	[
		'label' => Yii::t('github/local', 'has_test'),
		'format' => 'raw',
		'value' => function($data){
			if($data->has_test) {
	...
	[
		'label' => Yii::t('github/main', 'branch'),
		'attribute' => 'branch',
	],
	[
		'label' => Yii::t('github/local', 'last_commit'),
		'attribute' => 'head_commit.message',
	],
	/*[
		'label' => Yii::t('github/local', 'need_release'),
